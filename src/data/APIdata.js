export const dataMovies = [
  ...
  },
  {
    id: "1657284040373",
    title: "Mar Adentro",
    link: "https://m.media-amazon.com/images/I/51xVnVjZ4GL._AC_.jpg",
    desc: "Ramón (Javier Bardem) leva quase trinta anos debilitado em uma cama sob os cuidados de sua família. Sua única janela para o mundo é a de seu quarto, junto ao mar por onde tanto viajou e onde sofreu o acidente que interrompeu sua juventude. Desde então, seu único desejo é terminar com sua vida dignamente. A chegada de duas mulheres alternará seu mundo: Julia (Belén Rueda), a advogada que quer apoiar sua luta e Rosa (Lola Dueñas), uma vizinha do povoado que tentará convencer-lhe de que viver vale a pena. A luminosa personalidade de Ramón termina por cativar a ambas, que terão que questionar como nunca os princípios que regem suas vidas. Ele sabe que só a pessoa que o ama de verdade será aquela que vai lhe ajudar a realizar essa última viagem. Festival de Veneza - Vencedor do Grande Prêmio Especial do Juri, Copa Volpi de Melhor Ator e Melhor Filme Int'l - Indicado ao Leão de Ouro - Melhor Filme. Vencedor do Oscar de Melhor Filme Estrangeiro.",
  },
  {
    id: "1657284049867",
    title: "La lengua de las mariposas",
    link: "https://filmakersmovie.com/wp-content/uploads/2017/07/afichemariposas.png",
    desc: "Dirigida por José Luis Cuerda en 1999, La Lengua de las Mariposas es una exquisita muestra de exploración cinematográfica de tono político que se funde brillantemente con la tierna relación entre un maestro y su alumno en el año 1936. La película se suele definir como una historia de formación, ya que el personaje principal, Moncho, ve su vida constantemente interrumpida por los problemas que ocasionaba al país la Guerra Civil Española.   La película está basada en tres relatos del libro ¿Qué me quieres, amor? (1996), escrito por el autor gallego Manuel Rivas: La lengua de las mariposas, Un saxo en la niebla y Carmiña. La mayor parte de la historia está basada en el primero de los tres, al que se añaden algunos elementos de las otras dos historias, cohesionadas a través del personaje principal, Moncho.",
  },
  {
    id: "1657284059406",
...
export const dataGames = [
  {
    id: "1657284070663",
    title: "Gnomos ReSpin",
    link: "https://rfrancodigital.com/wp-content/uploads/2022/04/GnomosRespinw.png",
    desc: "Tras el gran éxito de la máquina tipo B ‘R. Franco Gnomos Mix’, R. Franco Digital lanza ‘Gnomos ReSpin’, una nueva slot online con 5 rodillos que te trasladará a un mundo de hadas y calderos de la suerte con las animaciones más dinámicas y emocionantes.",
  },
  {
    id: "1657284081603",
    title: "CYBORG 30L",
    link: "https://rfrancodigital.com/wp-content/uploads/2022/03/Cyborg30L_.png",
    desc: "R. Franco Digital lanza ‘CYBORG 30L’, una nueva slot online de cinco rodillos con tres filas que te transportará a un futuro donde las máquinas parecen humanas. Con la ayuda de Mecánica y su taller podrás construir tu propio ciborg que te llevará a ganar grandes premios.",
  },
  {
    id: "1657284127934",
    title: "Vacuum Buster",
    link: "https://rfrancodigital.com/wp-content/uploads/2022/06/VbusterNp1-1.png",
    desc: "R. Franco Digital lanza ‘Vacuum Buster’, una nueva slot online donde el mundo está sumido en el caos y el desorden por culpa de sofás malvados y temibles pelusas. Pero gracias a una superheroína y su potente aspiradora el orden y la limpieza volverán a reinar.",
  },
  {
    id: "1657284138653",
    title: "Witches South",
    link: "https://rfrancodigital.com/wp-content/uploads/2022/07/WitchesS_NP.png",
    desc: "R. Franco Digital lanza un nuevo hechizo con Witches South, una nueva slot online dispuesta a conquistar el mundo digital a través de un mundo mágico lleno de aventuras junto a la bruja del sur.",
  },
];
